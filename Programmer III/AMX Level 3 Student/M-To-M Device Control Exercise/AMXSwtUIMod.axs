MODULE_NAME='AMXSwtUIMod'(DEV dvTPs[],DEV vdvSwt,INTEGER nSources[],
                          ...
                          INTEGER nCurrentDestination, INTEGER nRemoteFlag)
(***********************************************************)
(*  FILE CREATED ON: 04/10/2004  AT: 21:49:39              *)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 06/16/2004  AT: 22:08:34        *)
(***********************************************************)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
BUTTON_EVENT[dvTPs,nSources]
{
  PUSH:
  {
    ...
    IF (nRemoteFlag)      //Control of remote master in enabled
    {
      SEND_STRING vdvSwt,"ITOA(nCurrentSource),',2,1',$03"
    }
